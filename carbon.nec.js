...
function id(x) {return x[0]; }
 ...
 function nullify(d) { return null } var grammar = {
    ...
    {"name": " string$4", "symbols": [{"literal":"s"}, {"literal":"t"}, {"literal":"r"}, {"literal":"u"}, {"literal":"c"}, {"literal":"t"}, {"literal":" "}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": " string$5", "symbols": [{"literal":"}"}, {"literal":";"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "struct", "symbols": [" string$4", "_", "word", "_", {"literal":"{"}, "structBits", "_", " string$5"], "postprocess":  function(d) { return ["struct", d[2], d[5]]} },
    ...
    {"name": " string$10", "symbols": [{"literal":"i"}, {"literal":"f"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "bareifStatement", "symbols": [" string$10", "_", {"literal":"("}, "_", "condition", "_", {"literal":")"}, "_", {"literal":"{"}, "block", "_", {"literal":"}"}], "postprocess":  function(d) { return ["if", d[4], d[9]] } },
    {"name": " string$11", "symbols": [{"literal":"e"}, {"literal":"l"}, {"literal":"s"}, {"literal":"e"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "elseIfStatement", "symbols": ["bareifStatement", "_", " string$11", "_", "ElseBlock"], "postprocess":  function(d) { return ["ifElse", d[0], d[4]] } },
    ...
    {"name": " string$16", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"t"}, {"literal":"u"}, {"literal":"r"}, {"literal":"n"}, {"literal":" "}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "return", "symbols": ["_", " string$16", "value"], "postprocess":  function(d) { return ["return", d[2]] } },
    ...
    {"name": "BlockComment", "symbols": [" string$17", "commentbody", " string$18"], "postprocess":  function(d) { return ["comment"] } },
    {"name": " string$19", "symbols": [{"literal":"/"}, {"literal":"/"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "LineComment", "symbols": [" string$19", "LineEnd"], "postprocess":  function(d) { return ["comment"]} },
    {"name": " string$20", "symbols": [{"literal":"w"}, {"literal":"h"}, {"literal":"i"}, {"literal":"l"}, {"literal":"e"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "WhileLoop", "symbols": [" string$20", "_", {"literal":"("}, "_", "condition", "_", {"literal":")"}, "_", {"literal":"{"}, "block", "_", {"literal":"}"}], "postprocess":  function(d) { return ["while", d[4], d[9]] } },
    {"name": " string$21", "symbols": [{"literal":"f"}, {"literal":"o"}, {"literal":"r"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "ForLoop", "symbols": [" string$21", "_", {"literal":"("}, "_", "assignment", {"literal":";"}, "_", "condition", {"literal":";"}, "_", "assignment", "_", {"literal":")"}, "_", {"literal":"{"}, "block", "_", {"literal":"}"}], "postprocess":  function(d) { return ["for", d[4], d[7], d[10], d[15]] } },
